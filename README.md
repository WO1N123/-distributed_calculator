...
# !!! Перед всеми действиями проверте что у вас установлен GCC одной из последних версий.

Проверить можно командой в cmd

`gcc --version`

Если у вас выдаёт ошибку скачайте GCC по ссылке - https://www.equation.com/servlet/equation.cmd?fa=fortran
